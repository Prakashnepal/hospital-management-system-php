        ...
        <div class="block">
          ...
          <div class="btn-container">
            <a
              ...
              target="_blank"
              class="btn btn-main-2 btn-icon btn-round-full">Check Symptoms <i class="icofont-simple-right ml-2"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-4">
        <div class="about-content pl-4 mt-4 mt-lg-0">
          ...
          <a
            href="service.html"
            class="btn btn-main-2 btn-round-full btn-icon">Services<i class="icofont-simple-right ml-3"></i></a>
        </div>
      </div>
    </div>
  </div>
